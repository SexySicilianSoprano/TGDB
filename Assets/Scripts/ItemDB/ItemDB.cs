...
public static class ItemDB {
    ...
    public static Item Scout = new Item
    {
		...
		ItemImage = Resources.Load("Item Images/gearsHouse/ScoutBoat_Icon", typeof(Sprite)) as Sprite,
        SortOrder = 0,
    ...
    public static Item Destroyer = new Item
    {
		...
		ItemImage = Resources.Load("Item Images/gearsHouse/Destroyer_Icon", typeof(Sprite)) as Sprite,
        SortOrder = 1,
        RequiredBuildings = new int[] { 1 },
        Cost = 450,
        BuildTime = 5.0f,
    ...
    public static Item FishingBoat = new Item
    {
        ...
        ItemImage = Resources.Load("Item Images/gearsHouse/FishingBoat_Icon", typeof(Sprite)) as Sprite,
        SortOrder = 1,
        RequiredBuildings = new int[] { 1 },
        Cost = 675,
        BuildTime = 7.0f,
    ...
    public static Item Dreadnought = new Item
    {
        ...
        ItemImage = Resources.Load("Item Images/gearsHouse/Dreadnought_Icon", typeof(Sprite)) as Sprite,
        SortOrder = 1,
        RequiredBuildings = new int[] { 1 },
        Cost = 300,
        BuildTime = 5.0f,
