...
public class MenuController : MonoBehaviour 
{
	...
	public void Close() //this function will be used for our "NO" button in our Quit Menu			
	{
	...
	{
        // GetComponent<AudioController>().StoreAndContinue();

        SceneManager.LoadScene("0.LoadingScreen");
